...
with(twodays,{
  plot(DateTime, as.numeric(paste(Global_active_power)), type="l", xlab ="", ylab = "Global Active Power")
  plot(DateTime, as.numeric(paste(Voltage)), type="l", xlab ="datetime", ylab = "Voltage")
  ...
  plot(DateTime, as.numeric(paste(Global_reactive_power)), type="l", xlab ="datetime", ylab = "Global_reactive_power")
  
}) 

## Step 9
#  Open a graphic device, save a png copy and close de device
dev.copy(png, file="plot4.png",width=480,height=480,res=49)
dev.off()
